...
// 2007, Jose Miguel Santos Espino
    ...
    memoryManager = new MemoryManager(NumPhysPages);  // As main memory is initialized in machine
    processTable = new Table(50); // 50-arbitary number of processes allowed in system
